...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">AMMA_E_FOOD</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../savory/index.jsp">Home</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead text-center text-white">
      ...
      <div class="bg-circle-4 bg-circle"></div>
        ...
        <% 
        	...
        	List<FoodBean> foodBean=foodDAO.getFoodBeanByUserId(userId);
        	for(FoodBean fb:foodBean){
            	...
            	<div class="p-5">
              <img class="img-fluid rounded-circle" src="../savory/images/<%=fb.getPath()%>" alt="">
            </div>
          </div>
          <div class="col-lg-6 order-lg-1">
            <div class="p-5">
              <h2 class="display-4"><%=fb.getName() %></h2>
